...
| **BUS-13** | Periodização Biomecânica | 6/10 | **Parcial** | 20h | Alto | Backend |
...
| **BUS-13** | `../backend/src/db/migrations/202607290011_create_workout_microcycles.js`, `../backend/src/controllers/workoutController.js`, `index.js` | `../backend/src/tests/migrations.test.js`, `api.test.js` | `Editor visual de microciclos, regras biomecânicas por exercício e versionamento/auditoria clínica` |
...
| 29/07/2026 | BUS-13 | Ficha pode persistir até 52 microciclos sequenciais com intensidade relativa, multiplicador de volume e notas; substituição é transacional e leitura respeita ownership | Branch `bus/bus-13-periodization`; backend API 68/68; migrations 27/27 | Parcial: editor visual, regras biomecânicas por exercício e auditoria/versionamento ainda pendentes |
