...
| **BUS-14** | `../backend/src/db/migrations/202607290012_add_catalog_governance.js`, `../backend/src/controllers/exerciseController.js`, `index.js` | `../backend/src/tests/migrations.test.js`, `api.test.js` | `Catálogo global realmente compartilhado, aprovação/moderação e deduplicação automática em lote` |
