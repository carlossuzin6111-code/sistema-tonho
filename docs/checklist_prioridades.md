...
| **OPS-01** | `../backend/src/db/migrations/202607290015_create_subscriptions.js`, `../backend/src/services/subscriptionService.js`, `../backend/src/controllers/subscriptionController.js`, `index.js` | `../backend/src/tests/migrations.test.js`, `api.test.js` | `Webhook de provedor, cobrança real, portal de assinatura e observabilidade de inadimplência` |
