...
const clickActions = Object.freeze({
  ...
  'open-manage-wearables': () => openManageWearablesModal(),
  'open-connect-wearable': () => openConnectWearableModal(),
  'close-connect-wearable': () => closeConnectWearableModal(),
  'revoke-wearable-connection': element => handleRevokeWearableConnection(element),
  'run-crm-daily': () => handleRunDailyCRM(),
  'resolve-crm-alert': element => handleResolveCRMAlert(element),
  'select-nps-score': element => handleSelectNPSScore(element),
  'close-nps-survey': () => closeNPSSurveyModal(),
  'open-manage-geofences': () => openManageGeofencesModal(),
  'open-add-geofence': () => openAddGeofenceModal(),
  'close-add-geofence': () => closeAddGeofenceModal(),
  'fill-current-location': () => fillGeofenceCurrentLocation(),
  'open-student-checkin': () => openStudentCheckinModal(),
  'close-student-checkin': () => closeStudentCheckinModal(),
  'get-checkin-location': () => getStudentCheckinLocation(),
  'checkout-geofence': element => handleStudentCheckout(element),
...
const submitHandlers = Object.freeze({
  ...
  'connect-wearable-form': event => handleConnectWearableSubmit(event),
  'nps-survey-form': event => handleNPSSurveySubmit(event),
  'add-geofence-form': event => handleAddGeofenceSubmit(event),
  'student-checkin-form': event => handleStudentCheckinSubmit(event),
