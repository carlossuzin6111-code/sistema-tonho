...
| **OPS-04** | `../backend/src/db/migrations/202607290018_create_wearable_integrations.js`, `../backend/src/controllers/wearableController.js`, `../backend/src/index.js` | `../backend/src/tests/wearables.test.js`, `migrations.test.js` | `Adaptadores OAuth/SDK por provedor, jobs de sincronização e recomendação de autorregulação baseada em sono/HRV` |
...
| 29/07/2026 | OPS-04 | Base agnóstica para conexões Apple HealthKit/Google Health Connect/Garmin, ingestão idempotente de sono/HRV, histórico com ownership e revogação; tokens não são armazenados no SQLite | Branch `ops/ops-04-wearables`; migration `202607290018_create_wearable_integrations.js`; testes focados 3/3 | Parcial: adaptadores OAuth/SDK, worker assíncrono, notificações e sugestão clínica de autorregulação ainda pendentes |
